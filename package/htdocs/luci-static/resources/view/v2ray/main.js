...
return L.view.extend({
    ...
    render: function (_a) {
        var _b = _a === void 0 ? [] : _a, _c = _b[0], inboundSections = _c === void 0 ? [] : _c, _d = _b[1], outBoundSections = _d === void 0 ? [] : _d;
        var m = new form.Map("v2ray", "%s - %s".format(_("V2ray"), _("Global Settings")), "<p>%s</p><p>%s</p>".format(_("A platform for building proxies to bypass network restrictions."), _("For more information, please visit: %s").format('<a href="https://www.v2ray.com" target="_blank">https://www.v2ray.com</a>')));
        var s = m.section(form.NamedSection, "main", "v2ray");
        s.addremove = false;
        s.anonymous = true;
        var o;
        ...
        o.depends("config_file", "");
        for (var _i = 0, inboundSections_1 = inboundSections; _i < inboundSections_1.length; _i++) {
            var s_1 = inboundSections_1[_i];
            o.value(s_1.value, s_1.caption);
        }
        o = s.option(form.MultiValue, "outbounds", _("Outbounds enabled"));
        o.depends("config_file", "");
        for (var _e = 0, outBoundSections_1 = outBoundSections; _e < outBoundSections_1.length; _e++) {
            var s_2 = outBoundSections_1[_e];
            o.value(s_2.value, s_2.caption);
        }
